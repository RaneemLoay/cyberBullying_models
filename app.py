...
def load_resources():
    global tokenizer, tfidf_vectorizer, tfidf_vectorizer, model_lstm, model_bilstm, model_gru, model_cnn ,model_svm
...
def predict():
    if request.method == 'POST':
        ...
        try:
            ...
            predicted_class = "bullying" if pred_svm[0] > 0.5 else "not bullying"
